...
hidemeta: true
cover:
    image: "https://blog.joaograssi.com/content/images/2020/08/asp-net-core-integration-tests-with-docker-compose-azure-pipelines.jpg"
    alt: "<alt text>"
    caption: "<text>"
    relative: false
comments: false
...
This is the third post in the [Integration tests in ASP.NET Core](https://blog.joaograssi.com/integration-tests-in-asp-net-core/) series.

- [Part 1: Limitations of the EF Core in-memory providers](https://blog.joaograssi.com/limitations-ef-core-in-memory-database-providers)

- [Part 2: Using docker-compose for your ASP.NET + EF Core integration tests](https://blog.joaograssi.com/using-docker-compose-for-your-asp-net-ef-core-integration-tests)

- [Part 3: ASP.NET Core integration tests with docker-compose on Azure Pipelines (this post)](https://blog.joaograssi.com/asp-net-core-integration-tests-with-docker-compose-azure-pipelines)
...
<div style="text-align:center">
    <img src="/content/images/2020/08/code_coverage_example.png" alt="Code coverage report on Azure DevOps">
</div>
